...
\begin{equation}
  ...
  \dot{Q}(z)=\frac{E(1+z)^2}{4\pi}\int_{\Omega}d\Omega\int_z^{z_{\mathrm{max}}} dz'\frac{dr}{dz'}\sigma n_{\mathrm{EBL}}\mathcal{E}(E',z') e^{-\tau}.
\end{equation}
...
\bar{\dot{Q}}=\frac{E(1+z)^2}{4\pi}\int_{\Omega}d\Omega\int dz' \frac{dr}{dz'}\sigma n_{\mathrm{EBL}}\bar{\mathcal{E}} e^{-\tau}.
\end{equation}
The resulting heating rate fluctuations are then given by
\begin{eqnarray}
\label{eq:fluc_exp0}
\delta_H(\mathbf{s})&=&\frac{\dot{Q}(\mathbf{s})-\bar{\dot{Q}}}{\bar{\dot{Q}}}=\frac{E(1+z)^2c\sigma n_{\mathrm{EBL}}}{4\pi\bar{\dot{Q}}} \int_{\Omega}d\Omega\int_z^{z_{\mathrm{max}}} dz'\frac{ ( \mathcal{E}(z')-\bar{\mathcal{E}}) e^{-\tau}}{H(z')} \\ \nonumber
&=&\frac{E(1+z)^2\bar{\mathcal{E}} c\sigma n_{\mathrm{EBL}}}{4\pi\bar{\dot{Q}}} \int_{\Omega}d\Omega\int_0^{z_{\mathrm{max}}} dz' \frac{\delta_E(z') e^{-\tau}}{H(z')}.
\end{eqnarray}
...
\delta_H(\mathbf{s})=\frac{ E(1+z)^2 \bar{\mathcal{E}} c\sigma n_{\mathrm{EBL}}}{4\pi\bar{\dot{Q}}} \int_{\Omega}d\Omega\int_z^{z_{\mathrm{max}}}dz' \frac{D(z')}{D(z)} \frac{\delta(r') e^{-\tau}}{H(z')}.
\end{equation}
...
\tilde{\delta}_H(k)=\tilde{\delta}(k) \frac{E(1+z)^2\bar{\mathcal{E}}c\sigma n_{\mathrm{EBL}}}{4\pi\bar{\dot{Q}}} \int_z^{z_{\mathrm{max}}} dz' \frac{D(z')}{D(z)}\frac{\sin(kr'(z'))}{kr'(z')} \frac{e^{-\kappa r'(z')}} {H(z')}.
\end{equation}
\begin{figure}[h]
\centering
...
\begin{equation}
\label{eq:mean_heat0}
\dot{Q}(\mathbf{s})=\frac{E(1+z)^2c\sigma n_{\mathrm{EBL}}\mathcal{\bar{E}}}{4\pi}\int_{\Omega}d\Omega\int_z^{z_{\mathrm{max}}} dz'\frac{D(z')}{D(z)}\left(1+\left(b(z)+\frac{2}{3}\right) \delta(r) -\frac{d\delta_{v_r}}{dr}\right).
\end{equation}
...
\begin{equation}
\label{eq:def_X}
\frac{dX}{dz'}=\frac{E(1+z)^2\mathcal{\bar{E}}c\sigma n_{\mathrm{EBL}}}{4\pi}\frac{e^{-\tau(z,z',E')}}{H(z')},
\end{equation}
...
\begin{eqnarray}
\label{eq:heat_fluc}
\tilde{W}_H(k,z)&=&\frac{E(1+z)^2\sigma n_{\mathrm{EBL}} c \mathcal{\bar{E}}}{4\pi\bar{\dot{Q}}}\int_z^{z_{\mathrm{max}}} dz' \frac{e^{-\tau}}{H(z')}\frac{D(z')}{D(z)}\left((b(z)+1)j_0(kr)-\frac{2}{3}j_2(kr)\right)\\
&=& \frac{\displaystyle \int_z^{z_{\mathrm{max}}} dz'  \mathcal{\bar{E}} \frac{e^{-\tau}}{H(z')}\frac{D(z')}{D(z)}\left((b(z)+1)j_0(kr)-\frac{2}{3}j_2(kr)\right)}{\displaystyle \int_z^{z_{\mathrm{max}}} dz'  \mathcal{\bar{E}} \frac{e^{-\tau}}{H(z')}}.
\end{eqnarray}
