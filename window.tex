...
\begin{equation}
\label{eq:phi_quasar}
\hat{\Lambda}_Q(z)=10^{-0.0037x^4+0.085x^3-0.778x^2+2.795x-2.133}\,,
\end{equation}
\begin{equation}
\label{eq:phi_quasar}
\hat{\Lambda}_Q(z)=10^{-0.035+1.48z-0.545z^2+0.070z^3-0.0037z^4}
\end{equation}
where $x=1+z$. [The latter is more directly useful, and as you can see
  directly, is not quite normalized correctly as Christoph noted.]
