...
\dot{Q}(\mathbf{x},z)= \frac{1}{4\pi} \int_{\Omega}\int_0^{r_{\mathrm{max}}} \frac{\mathcal{E}(\mathbf{r}'+\mathbf{x},z)}{D_{\mathrm{pp}}(z)} e^{-\tau}dr' d\Omega,
\end{equation}
...
which is very similar to \citet{2012MNRAS.422..106P}. Our model for galaxy bias is based on a fit of data by \citet{2005A&A...442..801M,1998ApJ...492..428S,2006ApJ...637..631K}. We use
  ...
  \end{equation}
Fig.~\ref{fig:bias}} shows the corresponding evolution of quasar and galaxy bias as a function of redshift. Using the same data, \citet{2008ApJ...678..627B} find that the quasar and galaxy bias can be fitted using a dark matter halo model of  $10^{13}h^{-1}M_{\odot}$ and $10^{12}h^{-1} M_{\odot}$ respectively. 
...
\begin{equation}
  ...
  \dot{Q}(\mathbf{x})=\frac{J(\mathbf{x})}{D_{pp}} =
...
\begin{eqnarray}
  ...
  (\mathcal{1}(\mathbf{r}'+\mathbf{x})-\frac{\bar{\mathcal{E}})}{D_{\mathrm{pp}}} e^{-\tau} \nonumber\\
  &=&\frac{1}{4\pi\bar{\dot{Q}}}\int_{\Omega}d\Omega\int_0^{r_{\mathrm{max}}} dr' \delta_E(\mathbf{r}'+\mathbf{x})\frac{\bar{\mathcal{E}}}{D_{\mathrm{pp}}} e^{-\kappa r'}.
\end{eqnarray}
