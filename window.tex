...
\caption{ Slices through the midplane of the box, for $z=3$ (left column) and $z=1$ (right column): logarithm of the density with respect to the mean value (upper row), heating rate fluctuations with the galaxy (middle row) and quasar bias model (lower row). \ALc{[{ figure needs cosmetic changes. Text needs some adjustments}]}}
\label{fig:slice}
\end{figure*}
\begin{figure*}
\centering
